...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div
            className="w-full bg-transparent font-sans md:px-10 flex items-center justify-center flex-col"
            ref={containerRef}
        >
            {/* <div className="max-w-7xl mx-auto py-10 md:py-20 px-4 md:px-8 lg:px-10">
                ...
                <p className="text-neutral-300 text-sm md:text-base max-w-sm">
                    Hier sind alle Giveaways aufgelistet, die bisher stattgefunden haben.
                </p>
            </div> */}
